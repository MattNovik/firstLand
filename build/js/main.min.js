...
var baseSuccessCallback = function baseSuccessCallback(event) {
  ...
  axios__WEBPACK_IMPORTED_MODULE_0__["default"].post("https://back.studuniverse.ru/api/public/user", formData).then(function (response) {
    ...
    if (response.order_id && response.action === "userIsset") {
      return window.location.href = "https://dev2.studservis-lk.ru/" + "orders/newOrder/id=" + response.order_id + "/new/";
    } else {
